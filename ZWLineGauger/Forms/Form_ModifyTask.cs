...
namespace ZWLineGauger.Forms
{
    public partial class Form_ModifyTask : Form
    {
        ...
        public Form_ModifyTask(MainUI parent)
        {
            ...
            checkBox_ApplySameDeltaToBothLimits.Checked = parent.m_bApplySameDeltaToBothLimits;
            ...
            if ((MEASURE_TYPE.LINE_WIDTH_1234 != parent.m_current_task_data[nStartIdx].m_mes_type))
                //&& (MEASURE_TYPE.LINE_WIDTH_BY_CONTOUR != parent.m_current_task_data[nStartIdx].m_mes_type)
                //&& (MEASURE_TYPE.LINE_TO_EDGE != parent.m_current_task_data[nStartIdx].m_mes_type))
            {
        ...
        private void textBox_UpperDelta_TextChanged(object sender, EventArgs e)
        {
            if ((textBox_UpperDelta.Text.Length > 0) && (textBox_StandardValue.Text.Length > 0))
            {
                ...
                if ((true == m_parent.m_bApplySameDeltaToBothLimits) && (true == textBox_UpperDelta.Focused))
                {
                    textBox_LowerDelta.Text = textBox_UpperDelta.Text;
                }
            }
        }
        ...
        private void textBox_LowerDelta_TextChanged(object sender, EventArgs e)
        {
            if ((textBox_LowerDelta.Text.Length > 0) && (textBox_StandardValue.Text.Length > 0))
            {
                ...
                if ((true == m_parent.m_bApplySameDeltaToBothLimits) && (true == textBox_LowerDelta.Focused))
                {
                    textBox_UpperDelta.Text = textBox_LowerDelta.Text;
                }
            }
        }
        ...
        private void textBox_UpperDelta2_TextChanged(object sender, EventArgs e)
        {
            if ((textBox_UpperDelta2.Text.Length > 0) && (textBox_StandardValue2.Text.Length > 0))
            {
                ...
                if ((true == m_parent.m_bApplySameDeltaToBothLimits) && (true == textBox_UpperDelta2.Focused))
                {
                    textBox_LowerDelta2.Text = textBox_UpperDelta2.Text;
                }
            }
        }
        ...
        private void textBox_LowerDelta2_TextChanged(object sender, EventArgs e)
        {
            if ((textBox_LowerDelta2.Text.Length > 0) && (textBox_StandardValue2.Text.Length > 0))
            {
                ...
                if ((true == m_parent.m_bApplySameDeltaToBothLimits) && (true == textBox_LowerDelta2.Focused))
                {
                    textBox_UpperDelta2.Text = textBox_LowerDelta2.Text;
                }
            }
        }
        ...
        private void checkBox_ApplySameDeltaToBothLimits_CheckedChanged(object sender, EventArgs e)
        {
            m_parent.m_bApplySameDeltaToBothLimits = checkBox_ApplySameDeltaToBothLimits.Checked;
        }
    }
}
