...
namespace ZWLineGauger.Forms
{
    public partial class Form_Settings : Form
    {
        ...
        public Form_Settings(MainUI parent)
        {
            ...
            checkBox_PopupModifyFormForODBTaskCreation.Checked = parent.m_bPopupModifyFormForODBTaskCreation;
            textBox_MaximumNumOfMeasureItemsForPopupModifyForm.Text = parent.m_nMaximumNumOfMeasureItemsForPopupModifyForm.ToString();
        ...
        private void btn_OK_Click(object sender, EventArgs e)
        {
            ...
            parent.m_bPopupModifyFormForODBTaskCreation = checkBox_PopupModifyFormForODBTaskCreation.Checked;
            parent.m_nMaximumNumOfMeasureItemsForPopupModifyForm = Convert.ToInt32(textBox_MaximumNumOfMeasureItemsForPopupModifyForm.Text);
        ...
        private void checkBox_PopupModifyFormForODBTaskCreation_CheckedChanged(object sender, EventArgs e)
        {
