...
{
    class Gauger_HandDrawLineToLine : Gauger
    {
        Point2d m_move_pt = new Point2d();

        public Gauger_HandDrawLineToLine(MainUI parent, PictureBox pb)
        {
            this.parent = parent;
            m_nPictureBoxWidth = pb.Width;
            m_nPictureBoxHeight = pb.Height;

            m_measure_type = MEASURE_TYPE.HAND_DRAWN_PARALLEL_LINE_TO_LINE;
        }
