...
{
    class Gauger_ComboLineToLine : Gauger
    {
        ...
        public Gauger_ComboLineToLine(MainUI parent, PictureBox pb, MEASURE_TYPE type)
        {
            this.parent = parent;
        ...
        {
            ((Gauger_ComboLineToLine)dest).m_bHasValidGaugeResult = m_bHasValidGaugeResult;

            for (int n = 0; n < m_gauge_result_pts.Length; n++)
                ((Gauger_ComboLineToLine)dest).m_gauge_result_pts[n] = m_gauge_result_pts[n];

            ((Gauger_ComboLineToLine)dest).m_gauged_line_space = m_gauged_line_space;
            ((Gauger_ComboLineToLine)dest).m_gauged_line_width = m_gauged_line_width;
            ((Gauger_ComboLineToLine)dest).m_gauged_line_width2 = m_gauged_line_width2;
