    ...
    class Gauger_LineSpace : Gauger
    {
        ...
        public override void copy_measure_result_data(ref Gauger dest)
        {
            for (int n = 0; n < m_gauge_result_pts.Length; n++)
                ((Gauger_LineSpace)dest).m_gauge_result_pts[n] = m_gauge_result_pts[n];

            ((Gauger_LineSpace)dest).m_bHasValidGaugeResult = m_bHasValidGaugeResult;
            ((Gauger_LineSpace)dest).m_gauged_line_space = m_gauged_line_space;
            ((Gauger_LineSpace)dest).m_gauged_line_width = m_gauged_line_width;
            ((Gauger_LineSpace)dest).m_gauged_line_width2 = m_gauged_line_width2;
