...
namespace ZWLineGauger.Gaugers
{
    class Gauger_ArcLineWidth : Gauger
    {
        ...
        {
            ((Gauger_ArcLineWidth)dest).m_bHasValidGaugeResult = m_bHasValidGaugeResult;

            for (int n = 0; n < m_gauge_result_pts.Length; n++)
                ((Gauger_ArcLineWidth)dest).m_gauge_result_pts[n] = m_gauge_result_pts[n];

            ((Gauger_ArcLineWidth)dest).m_gauged_line_space = m_gauged_line_space;
            ((Gauger_ArcLineWidth)dest).m_gauged_line_width = m_gauged_line_width;
            ((Gauger_ArcLineWidth)dest).m_gauged_line_width2 = m_gauged_line_width2;
